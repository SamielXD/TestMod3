...
public class FuseControls {
    ...
    private void buildUI() {
        ...
        TextureRegionDrawable knobBase = new TextureRegionDrawable(Core.atlas.white());
        style.knob = new TextureRegionDrawable(Core.atlas.white()) {
            @Override
            public void draw(float x, float y, float width, float height) {
                Draw.color(Color.valueOf("84f490"), 0.5f);
